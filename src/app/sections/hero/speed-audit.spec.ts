...
import { SpeedAudit } from './speed-audit';
import { PagespeedClient } from './pagespeed-client';

describe('SpeedAudit Component (Signal Forms URL Validation)', () => {
  let fixture: ComponentFixture<SpeedAudit>;
  let component: SpeedAudit;
  let pagespeed: PagespeedClient;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [SpeedAudit],
      providers: [PagespeedClient, provideRouter([])]
    }).compileComponents();

    fixture = TestBed.createComponent(SpeedAudit);
